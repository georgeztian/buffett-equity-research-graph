---
name: valuation
description: Estimate intrinsic value of a business
---

# Valuation

## Buffett's Stated Principle

Estimate intrinsic value as the present value of all future cash flows an investment will generate, discounted at an appropriate interest rate. It is the economic value that can be taken out of a business over its remaining lifetime.
...
- EBIT
- Operating income
- Operating income after taxes (operating income × (1 − tax rate); this is the single definition used for all ROE calculations in the moat, management, and margin of safety analyses)
- Price-to-earnings ratio
- Price-to-book ratio
- Net income
- Depreciation, Depletion, and Amortization (D&A)
- Other non-cash charges
- Capital expenditures (total CapEx, multi-year history)
- Book value of equity
- Tax rate
- Earnings per share (EPS)
- Share price (properly adjusted for stock splits, dividends, etc.)
- Free cash flow
...
- Current assets
- Current liabilities
- Change/Increase in Working Capital (Working Capital = Current assets - Current liabilities)
- Inventory
- Accounts receivable
- Accounts payable
- Total assets
...
For the Base Case, clearly state the following predictions and assumptions:
 - forecast horizon (e.g., forecast owner earnings over the next 5 years and terminal value applied to years after)
 - projected owner earnings over the forecast horizon
 - discount rate
 - terminal value estimates based on 1) DCF with Gordon Growth and 2) long-run (10-15 years) average P/E ratio, including their respective assumptions
 - draw a timeline to clearly illustrate all above in a clean way
