...
If the user gave a bare ticker in lower case (e.g. `axp`), pass it in upper case (`AXP`): a lower-case input is treated as a company name.
...
- `research/<KEY>/moat.md`, `management.md`, `valuation.md`, `business.md`, `mos.md`, `review.md`
